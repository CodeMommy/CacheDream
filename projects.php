...
array_push($projects['frontend']['projects'], array('name' => 'Google Hosted Libraries (Google AJAX)', 'url' => '/mirrors/google-hosted-libraries/', 'about' => 'The Google Hosted Libraries is a stable, reliable, high-speed, globally available content distribution network for the most popular, open-source JavaScript libraries
'));
...
array_push($projects['link']['projects'], array('name' => 'StaticFile', 'url' => 'http://www.staticfile.net/', 'about' => 'Professional front-end library CDN hosting'));
